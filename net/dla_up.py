...
class DLASeg(nn.Module):
    def __init__(self, base_name,
                 pretrained_base=None, down_ratio=4):
...
def dla34up(pretrained_base=True, **kwargs):
    model = DLASeg('dla34', pretrained_base=pretrained_base, **kwargs)
    return model
